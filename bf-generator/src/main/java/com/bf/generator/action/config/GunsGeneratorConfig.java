package com.bf.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.bf.admin.common.persistence.model");
        packageConfig.setMapper("com.bf.admin.common.persistence.dao");
        packageConfig.setXml("com.bf.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.bf.admin");
        contextConfig.setCoreBasePackage("com.bf.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\bf\\bf-admin");//写自己项目的绝对路径
