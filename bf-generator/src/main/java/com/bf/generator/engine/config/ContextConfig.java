package com.bf.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = "com.bf.admin";
    private String coreBasePackage = "com.bf.core";
    private String modelPackageName = "com.bf.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.bf.modular.system.dao";    //model的dao
