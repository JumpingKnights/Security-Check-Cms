package com.bf.modular.system.service.impl;
...
import com.bf.modular.system.dao.DictMapper;
...
import static com.bf.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new BfException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new BfException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
