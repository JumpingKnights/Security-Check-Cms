package com.bf.modular.code.factory;


import com.bf.BfApplication;
import com.bf.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setProjectPackage(BfApplication.class.getPackage().getName());
