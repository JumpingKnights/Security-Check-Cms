...
DROP DATABASE IF EXISTS security_check_cms;
CREATE DATABASE IF NOT EXISTS security_check_cms DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

USE security_check_cms;
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('105', 'system', '0', '[0],', '系统管理', 'fa-user', '#', '1', '1', '1', null, '1', '1');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('1', '世界', '10', '欢迎使用费乱污核查系统', '2017-01-11 08:53:20', '1');
